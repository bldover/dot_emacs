...
;; Primary colors
(defcustom monokai-white "#EFEFEF"
  "Primary color - white"
  :type 'string
  :group 'monokai)

(defcustom monokai-nearblack "#111111"
  "Primary color - nearblack"
  :type 'string
  :group 'monokai)
...
(defcustom monokai-background "#3A3A3A"
  "Adaptive colors - background"
  :type 'string
  :group 'monokai)

(defcustom monokai-comments "#878787"
...
(defcustom monokai-highlight "#843AA3"
  "Adaptive colors - highlight"
  :type 'string
  :group 'monokai)

(defcustom monokai-highlight-alt "#643AA3"
  "Adaptive colors - highlight"
  :type 'string
  :group 'monokai)

(defcustom monokai-highlight-line "#A43AA3"
...
(let* (;; Variable pitch
  ...
  (custom-theme-set-faces
   ...
   `(cursor
     ((,monokai-class (:foreground ,monokai-white
